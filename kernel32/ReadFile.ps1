function ReadFile
{
    ...
    $lpBuffer = New-Object -TypeName byte[] $Size
    [UInt32]$lpNumberOfBytesRead = 0

    $SUCCESS = $kernel32::ReadFile($FileHandle, $lpBuffer, $Size, [ref]$lpNumberOfBytesRead, [IntPtr]::Zero); $LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
